...
useEffect(() => {
const FetchallPandingRequest = async () =>{
try {
...
console.log("skknsskssk");
 ...
 if(res.data){
    ...
    console.log("error on fetch panding request" , error)
}
}



FetchallPandingRequest();
 ...
 useEffect(() => {
    ...
    const HandelStudentRequest = async ({action}) =>{
...
const token = await AsyncStorage.getItem("token");
    ...
    console.log(action);
        ...
        try {
            ...
            const res = await axios.post(`${API_URL}/warden/handle-request/${studentId}` , {
                action
            },
        ...
        if(res.data){
            console.log(res.data)
             ...
             console.log("error on accept or reject the request " , error);
        }
                ...
                {allrequest.map((item , index) => (
                    ...
                    <View key={item._id} style={styles.card}>
                        ...
                        {/* <View style={styles.infoRow}>
                            ...
                            <Text style={styles.value}>{student.parentPhoneNo}</Text>
                        </View> */}
                        ...
                        <View style={styles.buttonRow}>
                            <TouchableOpacity
                            onPress={()=>{ HandelStudentRequest({action : "decline"})
                            ...
                            <TouchableOpacity 
                            onPress={()=>{ HandelStudentRequest({action : "accept"})
                                                    setstudentId(item._id)
                        }}
