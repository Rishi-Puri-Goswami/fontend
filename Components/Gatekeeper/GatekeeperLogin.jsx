...
try {
      ...
      if(!token){
      return  console.log("no token user have to login");
      }
...
console.log("running")
    ...
    const loginuser = async () =>{
     ...
     try {
         ...
         const req = await axios.post(`${API_URL}/gatekeeper/loginGatekeeper`,{
           phoneNo , password 
         } , {
   ...
   navigate.navigate("GatekeeperPage");
      ...
      console.log("error on login gatekeeper" , error)
     }
